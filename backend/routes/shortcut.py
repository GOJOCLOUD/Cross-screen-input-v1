...
BASE_KEY_MAP = {
    ...
    'delete': Key.delete,
    'del': Key.delete,  # 别名
    'insert': Key.insert,  # Windows 上支持 Insert 键
    'ins': Key.insert,  # 别名
    ...
    'tab': Key.tab,
    'space': Key.space,
    'prtsc': Key.print_screen,  # Windows 上支持 Print Screen 键
    'printscreen': Key.print_screen,  # 别名
    'print_scr': Key.print_screen,  # 别名
    'ps': Key.print_screen,  # 别名
    'print': Key.print_screen,  # 别名
    'scroll_lock': Key.scroll_lock,  # Windows 上支持 Scroll Lock 键
    'scroll': Key.scroll_lock,  # 别名
    'pause': Key.pause,  # Windows 上支持 Pause 键
    'break': Key.pause,  # 别名
    'menu': Key.menu,  # Windows 上支持 Menu 键
    'apps': Key.menu,  # 别名
    
    # 锁定键
    'caps_lock': Key.caps_lock,
    'caps': Key.caps_lock,  # 别名
    'num_lock': Key.num_lock,  # Windows 上支持 Num Lock 键
    'num': Key.num_lock,  # 别名
...
async def get_platform_info():
    ...
    return {
        ...
        'note': '在 Windows 上，win 会映射到 Windows键。如果需要使用组合键，请按照 Windows 标准格式输入。'
    }
